    ...
    if key == "Вычислить" or key == "Вычислить время сортировки":
        ...
        if len(m1) == 3 and len(m2) == 3 and len(m3) == 3:
            for i in range(3):
                ...
                back_button = Button(window, text="Закрыть", width=15, height=2, font="consolas 10 bold", bg="white", fg="#000080", command = lambda: exit_run(window))
                ...
                b2_1.insert(END, "{:.3e}".format(tt1))
                b2_2.insert(END, "{:.3e}".format(tt5))
                b2_3.insert(END, "{:.3e}".format(tt9))

                b3_1.insert(END, "{:.3e}".format(tt2))
                b3_2.insert(END, "{:.3e}".format(tt6))
                b3_3.insert(END, "{:.3e}".format(tt10))

                b4_1.insert(END, "{:.3e}".format(tt3))
                b4_2.insert(END, "{:.3e}".format(tt7))
                b4_3.insert(END, "{:.3e}".format(tt11))

                b5_1.insert(END, "{:.3e}".format(tt4))
                b5_2.insert(END, "{:.3e}".format(tt8))
                b5_3.insert(END, "{:.3e}".format(tt12))
