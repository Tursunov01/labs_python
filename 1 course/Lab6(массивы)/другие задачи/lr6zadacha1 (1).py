...
n1=(input('Введите размер массива №1: '))                      # Ввод размера массива №1 
while True :
    k=0
...
n2=(input ('Введите размер массива №2: '))                      # Ввод размера массива №2 
while True :
    k=0
...
print()
print('Первый массив:')                                  #Вывод массивов 1 и 2
for x in a:
    print(x,end=' ')
